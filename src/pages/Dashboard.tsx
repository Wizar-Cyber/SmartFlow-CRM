    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-navy-card p-6 rounded-2xl shadow-sm border border-slate-800">
          ...
          <p className="text-xs text-slate-500 mt-2">4 launched this week</p>
        </div>
        ...
        <div className="bg-navy-card p-6 rounded-2xl shadow-sm border border-slate-800">
          ...
          <p className="text-xs text-slate-500 mt-2">v.s. $121,800 last month</p>
        </div>
        ...
        <div className="bg-navy-card p-6 rounded-2xl shadow-sm border border-slate-800">
          ...
          <p className="text-sm font-medium text-slate-400">Pending Contracts</p>
          <h3 className="text-3xl font-extrabold mt-1 text-white">07</h3>
          <p className="text-xs text-slate-500 mt-2">3 awaiting signature</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-navy-card rounded-2xl shadow-sm border border-slate-800 overflow-hidden">
          <div className="px-6 py-5 border-b border-slate-800 flex items-center justify-between">
            <h3 className="font-bold text-white">Project Status</h3>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-slate-800">
                {[
                  { name: 'Skyline Mobile App', client: 'TechCorp Inc.', progress: 75, status: 'In Progress', icon: 'auto_awesome', color: 'blue' },
                  { name: 'E-commerce Rebrand', client: 'Vogue Styles', progress: 100, status: 'Completed', icon: 'shopping_cart', color: 'emerald' },
                  { name: 'Security Audit', client: 'Global Finance', progress: 30, status: 'Reviewing', icon: 'shield', color: 'amber' },
                  { name: 'Internal Portal', client: 'SmartFlow', progress: 15, status: 'On Hold', icon: 'web', color: 'slate' },
                ].map((project, i) => (
        ...
        <div className="bg-navy-card rounded-2xl shadow-sm border border-slate-800 overflow-hidden">
          ...
          <div className="p-6 space-y-6">
            {[
              { user: 'Sarah Connor', action: 'completed the', target: 'Design Sprint', time: '2 hours ago', icon: 'check', color: 'emerald', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBFiGecl19kXyS0DH8E1dUHB64Hhicr3_pUQARMaM6ndrXXg936OoFdzWm3ci5wZLhXAMYAlr6Nnhcz08xdfBnwx57alet1lBhapHwwMsSiCLoZmiZydY0Z66o_2_PSGWeo4K7qMklTu4AYgd9gXVM2CMQjVY7iKGgh3aIgHbuOqk7U6EM1rVBQqKGCYS0pLAhwykCaxYwVg9qnou9o4k5uAg6FSi9pXtOi4w59WCi_dDTYZrRmCzvwvGo8IsgIDOSkDwSP7xeDCzQ' },
              { user: 'Mike Ross', action: 'uploaded new contracts for', target: 'Global Finance', time: '4 hours ago', icon: 'upload_file', color: 'blue', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBbN1uThTtFNMIHNzf2VrNFcKQG9thGo88sJ914jEI4A8UzmUFGhoKy-8wwfCIBDNNMiTeWPETzWrKfaSA8WW9iw6wAYjocISs6dYJBsTqggGQ60meen8XOadYEgCgEXDDL2TiQq6vSFdpd0HuEKClpnKopJQV_P7YzlleTmbKuimAew3pMwHdW86oXnjShDK4a5aWQV3OjCPOdKxESz5ombaS5UR1mkNpuSkOup6feU68zUfg_7wc15WlvZmIjaztAyl-JY8J-mNE' },
              { user: 'Harvey Specter', action: 'requested revision on', target: 'Invoice #8842', time: 'Yesterday', icon: 'error', color: 'amber', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBNiYEn_Wpaf-mKFBEJE67RRI2gPjnPQg8qqhKAcIZsjsHAaOiQxfDc6yf2CcQQL1EOcLO_7c_LIBKqEumd_s0F7sU9SX_KOe_0atI33o3UkfBua3WNfIeskBywYIPnFOK0zULSBVwTgymu2FPcWjT9oLEDJ81N-R88jsMsM8IhMHmAZP9gBGcA4BQ-2Q5Rrbu3GpUC09MZNFzG9nj8r0BtBdDZYXLkfrboFQ7KWK6HNmTduKRyuq830mcRcJxqpxVATw7wASLLL2A' },
              { user: 'Donna Paulsen', action: 'added a new client:', target: 'NextGen Robotics', time: 'Yesterday', icon: 'add', color: 'primary', img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBz2GOM6SSm27MoQRO7eTPqbNPA2FAxCZjmtrR8Imx4URbfEfOdJxi4kDAgAPk2qT-vvpbC18bgwPy2BDxT5SfEqwYb_mABRFDbyf11Z7gBh3WLvcyxL2I3c7vGpnmSSQh_J2HPTUJ3Wfvs7s7J88yPXDjBzerao7Tf7PL_p3hv4B5vopyQJPR434S4T6bLysY6d8Rt2OsfhrIcs9y-ZOJYnh7CdBzwaz46dQw7qphDt69Yibg70G_33Pc9nw-VZyrVobVf_y2hQiI' },
            ].map((activity, i) => (
